...
import { addFieldcrop } from '../actions/fieldcropAction';
import PropTypes from 'prop-types';

class FieldCropItemModal extends Component {
  state = {
    modal: false,
    name: '',
    moreinfolink: '',
  ...
  onSubmit = e => {
    ...
    this.props.addFieldcrop(newItem);
    ...
    return (
      <div>
        {this.props.isAuthenticated ? (
          ...
          <h4 className='mb-3 ml-4'>בבקשה התחבר בכדי לנהל את הגידולי שדה</h4>
        )}

        <Modal isOpen={this.state.modal} toggle={this.toggle}>
          <ModalHeader toggle={this.toggle}>הוספת גידול שדה</ModalHeader>
          <ModalBody>
